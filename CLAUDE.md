# brain3d - Guide de Développement Forge

> **FICHIER GÉNÉRÉ PAR FORGE - NE JAMAIS MODIFIER**
> En cas de modification, régénérer avec: `forge regenerate-claude brain3d`
> Ou via API: POST /api/skills/brain3d/regenerate-claude
...
**IMPORTANT**: Votre code sera automatiquement validé par `curl -X POST http://10.0.0.13:4080/api/validate/brain3d`
...
curl -X POST http://10.0.0.13:4080/api/validate/brain3d | jq .
...
☐ curl -X POST http://10.0.0.13:4080/api/validate/brain3d = valid: true
